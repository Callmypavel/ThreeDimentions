...
//Preprocessor
//-------------------------------------------------------------------------
#define HELPER_CLASS_NAME "peacemaker/threedimentions/NDKHelper" //Class name of helper function
//-------------------------------------------------------------------------
 ...
 * 使用android_native_app_glue的native应用的主要入口 主要在它自己的线程上运行
 * 同时也有它自己的接受输入事件的event loop
 */
